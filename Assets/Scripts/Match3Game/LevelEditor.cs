...
public class LevelEditor : MonoBehaviour {
    ...
    private void Update() {
        ...
        if (IsValidPosition(x, y)) {
            if (Input.GetKeyDown(KeyCode.F1)) grid.GetGridObject(x, y).SetGemSO(levelSO.gemList[0]);
            if (Input.GetKeyDown(KeyCode.F2)) grid.GetGridObject(x, y).SetGemSO(levelSO.gemList[1]);
            if (Input.GetKeyDown(KeyCode.F3)) grid.GetGridObject(x, y).SetGemSO(levelSO.gemList[2]);
            if (Input.GetKeyDown(KeyCode.F4)) grid.GetGridObject(x, y).SetGemSO(levelSO.gemList[3]);
            if (Input.GetKeyDown(KeyCode.F5)) grid.GetGridObject(x, y).SetGemSO(levelSO.gemList[4]);
