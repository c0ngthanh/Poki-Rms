...
public class Match3Visual : MonoBehaviour
{
    ...
    [SerializeField] private GameObject gemGridHolder;
    ...
    public void Setup(Match3 match3, Grid<Match3.GemGridPosition> grid)
    {
        ...
        for (int x = 0; x < grid.GetWidth(); x++)
        {
            for (int y = 0; y < grid.GetHeight(); y++)
            {
                ...
                gemGridVisualTransform.SetParent(gemGridHolder.transform);
                ...
                Transform pfBackgroundGridVisualTransform = Instantiate(pfBackgroundGridVisual, grid.GetWorldPosition(x, y), Quaternion.identity);
                pfBackgroundGridVisualTransform.SetParent(gemGridHolder.transform);
            }
        }
    ...
    public void ShowGemGrid()
    {
        gemGridHolder.gameObject.SetActive(true);
    }
    public void HideGemGrid()
    {
        gemGridHolder.gameObject.SetActive(false);
    }
